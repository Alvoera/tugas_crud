...
<body>
    <fieldset >
    <!--Judul pada fieldset-->
        <legend align="center">Alim Book Store</legend>
        <h3>
        ...
        <center>||<a href="update_penerbit.html">Tambah Data</a>||</center>
        <br>
...
<div class="table_keren">
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <td><a href="edit_penerbit.php?id_penerbit=<?php echo $row['id_penerbit']; ?>">Edit</a></td>
